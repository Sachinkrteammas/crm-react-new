...
import { fetchCDRReportOld } from '../services/authService';
...
function sumDurations(...durations) {
  ...
  const handleViewClick = async () => {
    ...
    try {
        ...
        const response = await fetchCDRReportOld(payload);
  ...
  <>
    ...
    <div className="row gy-4 gx-3">
      ...
      <div className="card p-4 mb-4">
        <h5 className="mb-3">CDR REPORT OLD</h5>
