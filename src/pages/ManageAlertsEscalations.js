...
export default function ManageAlertsEscalations() {
  ...
  const [editingEscalationAlertId, setEditingEscalationAlertId] = useState(null);
  ...
  useEffect(() => {
      const fetchLevel1 = async () => {
        if (!selectedClient) return;
        try {
          const res = await api.get(`/core_api/categories/level1?client_id=${selectedClient}`);
  ...
  useEffect(() => {
      ...
      const fetchLevel2 = async () => {
        try {
          const res = await api.get(`/core_api/categories/level2/${selectedLevel1}?client_id=${selectedClient}`);
  ...
  useEffect(() => {
      ...
      const fetchLevel3 = async () => {
        try {
          const res = await api.get(`/core_api/categories/level3/${selectedLevel2}?client_id=${selectedClient}`);
  ...
  useEffect(() => {
      ...
      const fetchLevel4 = async () => {
        try {
          const res = await api.get(`/core_api/categories/level4/${selectedLevel3}?client_id=${selectedClient}`);
  ...
  useEffect(() => {
      ...
      const fetchLevel5 = async () => {
        try {
          const res = await api.get(`/core_api/categories/level5/${selectedLevel4}?client_id=${selectedClient}`);
  ...
  const handleInternalAdd = async () => {
    ...
    try {
      if (editingInternalAlertId) {
          ...
          await api.put(`/internal/alert-mechanism/${editingInternalAlertId}`, payload);
      ...
      console.error(err);
      alert(editingInternalAlertId ? "Error updating internal alert." : "Error saving internal alert.");
    }
  };
  ...
  const handleInternalEdit = async (alert) => {
      ...
      try {
        ...
        if (s1) {
          const res2 = await api.get(`/core_api/categories/level2/${s1}?client_id=${selectedClient}`);
        ...
        // Step 3: Level 3
        if (s2) {
          const res3 = await api.get(`/core_api/categories/level3/${s2}?client_id=${selectedClient}`);
        ...
        // Step 4: Level 4
        if (s3) {
          const res4 = await api.get(`/core_api/categories/level4/${s3}?client_id=${selectedClient}`);
        ...
        // Step 5: Level 5
        if (s4) {
          const res5 = await api.get(`/core_api/categories/level5/${s4}?client_id=${selectedClient}`);
  ...
  const fetchEscalationAlerts = async () => {
      ...
      try {
        const res = await api.get(`/escalation/alert-mechanism?client_id=${selectedClient}`);
  ...
  const handleEscalationAdd = async () => {
      ...
      try {
        if (editingEscalationAlertId) {
          await api.put(`/escalation/alert-mechanism/${editingEscalationAlertId}`, payload);
        ...
        console.error(err);
        alert(editingEscalationAlertId ? "Error updating escalation alert." : "Error saving escalation alert.");
      }
  };
  ...
  return (
    <div className="row">
      ...
      {selectedClient ? (
              ...
              <div className={cardClass}>
                <div className="card-body">
                  <h5 className="card-title mb-4 text-secondary">
                    Alert Mechanism — <span className="text-primary text-capitalize">{activeAlertSection}</span>
                  </h5>
                        ...
                        <div className="col-md-4">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              const found = templates.find((t) => t.template_name === name);
                              setCallerTemplateText(found?.template_text || "");
                            }}
                          >
                      ...
                      <form className="row g-4">
                        ...
                        <div className="col-md-3">
                          ...
                          <select
                            ...
                            onChange={(e) => setInternalAlertOn(e.target.value)}
                          >
                            <option value="">Select</option>
                            <option value="SMS">SMS</option>
                            <option value="Email">Email</option>
                        ...
                        {level2Categories.length > 0 && (
                          <div className="col-md-3">
                            <label className="form-label fw-semibold">Sub Scenario</label>
                            <select
                              className="form-select shadow-sm rounded-2"
                        ...
                        {level3Categories.length > 0 && (
                          <div className="col-md-3">
                            <label className="form-label fw-semibold">Sub Scenario 3</label>
                            <select
                              className="form-select shadow-sm rounded-2"
                        ...
                        {level4Categories.length > 0 && (
                          <div className="col-md-3">
                            <label className="form-label fw-semibold">Sub Scenario 4</label>
                            <select
                              className="form-select shadow-sm rounded-2"
                        ...
                        {level5Categories.length > 0 && (
                          <div className="col-md-3">
                            <label className="form-label fw-semibold">Sub Scenario 5</label>
                            <select
                              className="form-select shadow-sm rounded-2"
                              ...
                              {internalAlerts.map((alert) => (
                                <tr key={alert.id}>
                                  ...
                                  <td className="d-flex gap-2">
                                    <button className="btn btn-sm btn-warning" onClick={() => handleInternalEdit(alert)}>
                                      Edit
                                    </button>
                                    <button className="btn btn-sm btn-danger" onClick={() => handleInternalDelete(alert.id)}>
                                      Delete
                                    </button>
                                  </td>
                                </tr>
                  ...
                  {activeAlertSection === "escalation" && (
                    <div>
                      ...
                      <form className="row g-4">
                        ...
                        <div className="col-md-3">
                          ...
                          <select
                              ...
                              onChange={(e) => setEscalationAlertOn(e.target.value)}
                          >
                              <option value="">Select</option>
                              <option value="SMS">SMS</option>
                              <option value="Email">Email</option>
                        ...
                        <div className="col-md-3">
                          ...
                          <input
                              ...
                              onChange={(e) => setEscalationPersonName(e.target.value)}
                              placeholder="Person Name"
                          />
                        </div>
                        <div className="col-md-3">
                          ...
                          <input
                              ...
                              onChange={(e) => setEscalationPersonPhone(e.target.value)}
                              placeholder="Mobile No."
                          />
                        </div>
                        <div className="col-md-3">
                          ...
                          <input
                              ...
                              onChange={(e) => setEscalationPersonEmail(e.target.value)}
                              placeholder="Email"
                          />
                        </div>
                        <div className="col-12 d-flex justify-content-center gap-3 mt-4">
                      ...
                      <div className="mt-5">
                      <h5 className="fw-bold mb-3">Existing Escalation Alerts</h5>
                      {loadingEscalations ? (
                        <p>Loading...</p>
                            ...
                            {escalationAlerts.map((alert) => (
                              <tr key={alert.id}>
                                ...
                                <td>
                                  <button
                                    className="btn btn-sm btn-warning me-2"
                                    onClick={() => handleEscalationEdit(alert)}
                                  >
                                    Edit
                                  </button>
                                  <button
                                    className="btn btn-sm btn-danger"
                                    onClick={() => handleEscalationDelete(alert.id)}
                                  >
                                    Delete
                                  </button>
                                </td>
        ...
        (userType === "Super-Admin" || userType === "Admin") && (
          <p className="card-title text-muted">Please select a client to manage alerts & escalations.</p>
        )
      )}
    </div>
  );
